...
public class Skeleton : Enemy, IDamageable // ---> Mono yerine Enemy yaptık çünkü Enemy Script'inden her şeyi alacağız. IDamageable interface'i buradan implemente ediyoruz.
{
    ...
    public void Damage() // ---> IDamageable interface'inde sözleşme olarak bahsettiğimiz değişkenleri burada kullanmamız gerekiyor.
    {
        ...
        Health = Health - _player.PlayerDamage; // ---> Damage methodu çağrıldığında Healt -1 aşağı inecek.
